...
// -----------------------------Registration------------------
export const teamhandleRg = ({ popWindowData_V2, popWindowData, visitorinfo, gamedetail, intl, history, location, configData, tournamentName, holdingClubName, readIcon }) => {
