...
//handle all btns
import { singlehandleDIL, teamhandleDd } from '../../TJ_single_handlebtn2'
...
const SingleJoinCodeAndRequireData = () => {
    //btn funtion分寫
    const { setProcessDIL, history, location, configData, intl, gameRegEtime, dialogData, popWindowData, authData, gameserial, regid, setCurrentPage, joincode, setJoinCode, requrieddata, setRequriedData, needjoincode, readytosend, setReadyToSend, finalregdata, regitsterfinish } = useContext(Singlegameprovider)
