...
const TeamConfirmation = () => {
    ...
    useEffect(() => {
        ...
        if (RegBkOK.current) {
            ...
            //當註冊成功觸發時才會轉頁過跳窗
            teamhandleRg({ popWindowData, visitorinfo, gamedetail, intl, history, location, configData, tournamentName, holdingClubName, readIcon })
            history.replace({
                ...location,
